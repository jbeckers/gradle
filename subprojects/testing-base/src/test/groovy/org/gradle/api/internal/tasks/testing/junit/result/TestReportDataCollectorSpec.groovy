...
class TestReportDataCollectorSpec extends Specification {
    ...
    def "keeps track of test results"() {
        ...
        def result2 = new DefaultTestResult(FAILURE, 250, 300, 1, 0, 1, asList(new DefaultTestFailure(new RuntimeException("Boo!"), false, null, null, null, null)))
    ...
    def "writes test outputs for failed suite"() {
        def suite = new DefaultTestSuiteDescriptor("1", "Suite")
        def failure = new DefaultTestFailure(new RuntimeException("failure"), false, null, null, null, null)
    ...
    def "collects failures for test"() {
        def test = new DefaultTestDescriptor("1.1.1", "FooTest", "testMethod")
        def failure1 = new DefaultTestFailure(new RuntimeException("failure1"), false, null, null, null, null)
        def failure2 = new DefaultTestFailure(new IOException("failure2"), false, null, null, null, null)
    ...
    def "handle PlaceholderExceptions for test failures"() {
        def test = new DefaultTestDescriptor("1.1.1", "FooTest", "testMethod")
        def failure = new DefaultTestFailure(new PlaceholderException("OriginalClassName", "failure2", null, "toString()", null, null), false, null, null, null, null)
    ...
    def "handles exception whose toString() method fails"() {
        def test = new DefaultTestDescriptor("1.1.1", "FooTest", "testMethod")
        def failure2 = new DefaultTestFailure(new RuntimeException("failure2"), false, null, null, null, null)
    ...
    def "reports suite failures"() {
        ...
        collector.afterSuite(testWorker, new DefaultTestResult(FAILURE, 50, 450, 2, 1, 1, [new DefaultTestFailure(new RuntimeException("Boo!"), false, null, null, null, null)]))
        collector.afterSuite(root, new DefaultTestResult(FAILURE, 0, 500, 2, 1, 1, []))
