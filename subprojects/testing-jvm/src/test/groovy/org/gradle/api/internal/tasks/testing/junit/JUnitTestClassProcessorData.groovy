...
public class ABrokenTestClass {
    static def failure = new DefaultTestFailure(new RuntimeException(), false, null, null, null, null)

    @Test
    public void broken() {
        throw failure.rawFailure.fillInStackTrace()
    }
}
...
public class ATestClassWithBrokenBeforeAndAfterMethod {
    static def beforeFailure = new DefaultTestFailure(new RuntimeException(), false, null, null, null, null)
    static def afterFailure = new DefaultTestFailure(new RuntimeException(), false, null, null, null, null)

    @Before
    public void setup() {
        throw beforeFailure.rawFailure.fillInStackTrace()
    }

    @After
    public void teardown() {
        throw afterFailure.rawFailure.fillInStackTrace()
    }
...
public class ATestClassWithBrokenSuiteMethod {
    static def failure = new DefaultTestFailure(new RuntimeException('broken'), false, null, null, null, null)
...
public class CustomRunner extends Runner {
    ...
    public void run(RunNotifier runNotifier) {
        ...
        runNotifier.fireTestFailure(new Failure(test1, failure.rawFailure.fillInStackTrace()))
